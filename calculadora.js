...
function calculadora() {
  ...
  if (num1=== null & num2 === null) {
    ...
    alert("Con los numeros " + num1+ " y " + num2 +
    "\n El resultados de la suma entre estos numeros es " +resultados[0]+
    "\n El resultados de la resta entre estos numeros es " +resultados[1]+
    "\n El resultados de la multiplicación entre estos numeros es " +resultados[2]+
    "\n El resultados de la división entre estos numeros es " +resultados[3])
